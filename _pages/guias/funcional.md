...
Los siguientes ejercicios deben ser pensados dentro del paradigma funcional. Pueden ser resueltos utilizando otros paradigmas, pero el objetivo es resolverlos en dicho paradigma, específicamente utilizando el lenguaje Scala.
Para resolverlos se deben utilizar los conceptos y las herramientas vistas en clase, aunque puede ser necesario investigar otras por cuenta propia.
...
2. Escribir una función `filtrar(listas:List[List[Int]], n:Int): List[Int]` que reciba una lista que contenga listas de enteros y un número `n`, y filtre los números mayores 
a `n`.
